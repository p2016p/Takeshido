...
public class takeshido_meiyoGen {
    ...
    public void generate(SectorAPI sector) {
     ...
     // Excelling terran world, for classic racers and such
        PlanetAPI  meiyo_3 = system.addPlanet("takeshido_oashisu",
        		meiyo_star,
                "Oashisu",
                "terran-eccentric",
                280f, //starting angle
                ...
                4600f, // orbit radius
                442f); // orbit time
        meiyo_3.setCustomDescriptionId("takeshido_oashisuxxx");
...
//        meiyo_3_market.getIndustry(Industries.MINING).setAICoreId(Commodities.GAMMA_CORE);
        ...
        CustomCampaignEntityAPI  meiyo_station = system.addCustomEntity("takeshido_nino_station", "Nino Station", "station_hightech3", "pirates");
...
//
     ...
     // Inner system jump point
        JumpPointAPI jumpPoint1 = Global.getFactory().createJumpPoint("takeshido_meiyo_inner_jump", "Inner Jump Point");
