...
public class sevencorpGenTakeshido implements SectorGeneratorPlugin {
    ...
    public void generate(SectorAPI sector) {
        ...
        //nuke: let's experience with dynamically modifying hull frequencies. is it possible?
...
//        FactionAPI bushido = sector.getFaction("bushido");
        ...
        //vanilla factions
        //nuke: getID stopped working after I started calling the gen function from an if chain? which is why I had to swap to using the string literal IDs instead
